...
class Model(tf.keras.Model):
    ...
    def call(self, image_sequences, feature, training):
        ...
        # rnn block
        feature_image = self.apply_list_of_layers(encoded_image_sequences, self.rnn_layer, training)

        encoded_image = self.apply_list_of_layers(feature_image, self.final_encoding_layer, training)
